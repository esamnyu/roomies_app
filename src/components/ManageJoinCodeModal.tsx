  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-background rounded-lg p-6 max-w-md w-full text-center">
        ...
        {code && !error && (
          <div className="my-4">
            <p className="text-foreground mb-2">Share this code with new members:</p>
            <div className="inline-flex items-center">
              <p className="text-3xl font-bold tracking-widest bg-secondary p-3 rounded-md text-primary">
                {code}
              </p>
              <Button 
                variant="outline"
